    ...
    <div class="my_page" style="display: flex;">
      ...
      <div class="ticket_sale_" style="display: none;">
        ...
        <div class="com_ticket_info">
          ...
          <div class="c_info_text such_text">- 예매권/할인권은 반드시 본인인증을 하셔야만 등록 가능합니다.</div>
        ...
        <div class="c_info_box">
          <div class="c_info">
            ...
            <div class="c_info_text">로그인 후 받으신 고유 번호를 등록하여 원하는 극장과 날짜의 영화를 예매할 수 있는 무료 이용권입니다.<br>단, 예매권의 형태에 따라 사용방법이 상이하오니 예매권이 종류를 정확히 확인 해주세요.<br><br>- 일반영화 예매권 : YES24에서 예매 가능한 모든 극장과 날짜의 영화 예매 가능<br>- 지정영화 예매권 : 예매권에 지정된 영화만 예매 가능<br>- 1+1예매권 : 2인 이상 예매시 1매 예매 가능<br>- 평일 예매권 : 토요일, 일요일, 공휴일을 제외한 평일영화만 예매 가능</div>
         </div>

          <div class="c_info" style="position: relative; top: 30px;">
            <div class="c_info_name">할인권</div>
            <div class="c_info_text">로그인 후 받으신 고유 번호를 등록하여 예매시, 할인권 금액만큼 할인 받고 예매할 수 있는 이용권입니다.<br>※ 예매권/할인권의 분실 또는 도난에 대해서는 YES24가 책임지지 않습니다.</div>
          </div>

          <div class="c_info" style="position: relative;bottom: 90px;">
            <div class="c_info_name" >예매권/할인권 등록</div>
            <div class="c_info_text">- 영화예매권/할인권을 등록하신 이후에는 반드시 나의 예매내역 > 예매권/할인권 에서 등록된 예매권의 사용기간과 사용매수, 할인금액을 확인하시기 바랍니다.<br>- 영화예매권 결제는 관람요금이 14,000원 이하인 경우에 한합니다. (극장별 3D상영버전이나 묶음상영, 일부 극장의 주말 요금이 14,000원을 초과할 경우 예매권 결제 금액에 따라 이용불가)<br>- 영화예매권/할인권 등록만으로 영화관람은 불가능하며, 반드시 예매 마감 시간 전에 YES24 영화에서 영화 예매를 완료하셔야 합니다. (영화, 극장, 날짜, 회차 등 선택 후 마지막 결제 단계에서 예매권, 할인권 사용 가능)<br>- 영화예매권/할인권에 지정된 사용기간은 따로 표기가 있지 않으면 예매일 기준입니다.(관람일이 예매권/할인권 사용기간 이후라도, 기간안에 미리 예매해두시면 됩니다.)<br>- 특정한 영화나 극장이 지정된 영화예매권/할인권 인지 확인해 주세요. 영화가 지정된 영화예매권은 사용기간 내에 해당영화가 종영되면 사용기간이 남아도 영화예매권을 사용할 수 없습니다.<br>- 예매권/할인권은 YES24 영화에서 예매가 가능한 상영관에 한 해 사용이 가능합니다. (예매가 오픈 되지 않는 일부 특별관 제외)<br>- 영화할인권은 한번 예매시 1개만 사용 가능합니다. (단, 마니아 추가혜택 영화할인권은 해당 영화할인권에 한해 2매 이상 예매시 2개 동시 사용이 가능합니다.)<br>- 영화예매권/할인권으로 예매 후 극장에서 예매번호로 반드시 티켓발권을 하셔야 합니다.</div>
          </div>
