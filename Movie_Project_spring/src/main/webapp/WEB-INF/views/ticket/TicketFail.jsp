...
<link href="../css/ticket/ticket_fail.css" rel="stylesheet" type="text/css">
...
<div class="title_right">
  ...
  <!--여기까지 기본 위 배너 입니다!-->
     <!-- 제일 최하단 -->
     <div class="gray_box">
      <div class="fail_name">userID님의 예매가 실패 되었습니다.</div>
      <div class="fail_info"><div class="fail_text">예매과정에서 오류가 발생하였습니다</div></div>
      <div class="a_tag"><a href="" class="fail_link"><div class="fail_button"><br>메인으로</div></a></div>
     </div>
