$(function(){
	...
	$(".photob").click(function(){
		...
		$(".dropdown_sub_3_3").wrap('<a href="."></a>');
	...
	$(".dropdown_main_3").click(function(){
		...
		$(subc).click(function(){
		$(".dropdown_subC").wrap('<a href="../../info/"></a>'); 
		$(".dropdown_sub_3_3").wrap('<a href="../../info/"></a>');
	...
	$(".dropdown_sub_3_3").click(function(){
		$(".dropdown_sub_3_3").wrap('<a href="../../info/"></a>');
		$(".dropdown_subC").wrap('<a href="../../info/"></a>'); 
		if($(sub3_2).css("display")=="none"){
		$(sub3_1).css("display","block");
